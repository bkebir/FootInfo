    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav col-md-auto mx-auto">
                ...
                <li class="nav-item me-4">
                    <a class="nav-link active" href="actualite.php">Actualite</a>
                </li>
                <li class="nav-item me-4">
...
<body>
    <div class="container">
        ...
        <?php
        echo "<p><hr><p>";
        // Récupérer tous les matchs à venir disponibles pour les 3 prochains jours
        $now = new DateTime();
        $end = new DateTime();
        $end->add(new DateInterval('P3D'));
        $response = $api->findMatchesForDateRange($now->format('Y-m-d'), $end->format('Y-m-d'));
        ?>
        <h3 style="font-weight:bold;"> Matchs à l'affiche (3 prochains jours)</h3>
