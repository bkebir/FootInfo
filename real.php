...
<body>
  <div class="container">
    ...
    ?>
    <h3 style="font-weight: bold;"><img class=" logoCity" src="Img/Real_Madrid-removebg-preview.png" alt="BPL" width="180"> Matchs - Real Madrid FC </h3>
    ...
    <?php
    echo "<p><hr><p>";
    // afficher les joueurs d'une équipe spécifique (ici id = 86 correspond au Real de Madrid)
    $team = $api->findTeamById(86);
    ?>
    <h3 style="font-weight: bold;"><img class="maillot" src="Img/maillot_real.png" alt="BPL" width="120"> Effectifs - <?php echo $team->name; ?></h3>
    <table class="table table-primary table-striped table-hover table table-bordered">
      <tr>
        <th>Nom</th>
        <th>Position</th>
